...
$t = new Fly_Flexy_Translator(array(
    'baseLang'      => 'en',
...
class Fly_Flexy_Translator {
    ...
    */
    ...
    function Fly_Flexy_Translator($options= array()) {
    ...
    */
    function outputDefaultTemplate() {
        $o = array(
            'compileDir' => ini_get('session.save_path') . '/Fly_Flexy_Translate',
