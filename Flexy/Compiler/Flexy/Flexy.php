...
class Fly_Flexy_Compiler_Flexy_Flexy  {
    ...
    function functionToString($element)
    {
        if ($arg = $element->getAttribute('NAME')) {
            ...
            $GLOBALS['_FLY_FLEXY']['prefixOutput']  .=
                ...
                .
                preg_replace('/\$this-/', '$_fly_flexy_this-', $element->compileChildren($this->compiler))
                .
                $this->compiler->appendPHP( "\n}\n");
        ...
        if (is_string($element->ucAttributes['CALL'])) {
            ...
            return $this->compiler->appendPHP(
                    "if (function_exists('_fly_flexy_compiler_flexy_flexy_{$arg}')) " .
                    " _fly_flexy_compiler_flexy_flexy_{$arg}(\$t,\$this);");
        }
        ...
        return $this->compiler->appendPHP(
            "if (function_exists('_fly_flexy_compiler_flexy_flexy_'.{$add})) ".
            "call_user_func_array('_fly_flexy_compiler_flexy_flexy_'.{$add},array(\$t,\$this));");
