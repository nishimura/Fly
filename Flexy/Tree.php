...
class Fly_Flexy_Tree {
        ...
        while ($t = $tokenizer->yylex()) {
            ...
            if ($t == FLY_FLEXY_TOKEN_ERROR) {
                return Fly_Flexy::raiseError(
                    array(
                            "Fly_Flexy_Tree::Syntax error in File: %s (Line %s)\n".
                            "Tokenizer Error: %s\n".
                            "Context:\n\n%s\n\n >>>>>> %s\n",
                    ...
                    ,FLY_FLEXY_ERROR_SYNTAX ,FLY_FLEXY_ERROR_DIE);
            }
    ...
    */
    ...
    function matchClosers()
    {
        ...
        $i = $total;
        $this->tokens[$i] = new Fly_Flexy_Token;
    ...
    *
    * @return  Fly_Flexy_Token (base of tree.)
    * @access   public
    */
